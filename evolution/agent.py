...
class Agent :
    ...
    def __init__(self, level, max_turns, lowest_score_allowed, on_game_over) :
        self.level                = level
    ...
    def tick(self) :
        ...
        if ate_food :
            self._add_score(config.score.points_ate_food)
    ...
    def _update_score(self, is_food: bool) :
        ...
        if is_food :
            self._add_score(config.score.points_towards_food)
        else :
            self._add_score(config.score.points_against_food)
